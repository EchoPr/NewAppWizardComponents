...
////end block
		public static void api_get(List<ApiEntry> lst) {
			...
			lst.Add(new ApiEntry(0, "qform_window_pos_get", null,typeof(RWindowPosition), false, new LStr [] { new LStr("QForm", "QForm", "QForm"), new LStr("UserInterface", "User interface", "Интерфейс пользователя") }));
			lst.Add(new ApiEntry(0, "qform_window_pos_set", typeof(AWindowPosition), null, false, new LStr [] { new LStr("QForm", "QForm", "QForm"), new LStr("UserInterface", "User interface", "Интерфейс пользователя") }));
...
////block api-types
	...
	public class AExportFieldsAtTrackingPoints {
		...
		public AExportFieldsAtTrackingPoints () {
			...
			values_on_sheet = ValuesOnSheet.at_point;
